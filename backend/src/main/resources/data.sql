...
--
--insert into balance(id,fk_user1,fk_user2,amount) values(1,10001,10002,0);
--insert into balance(id,fk_user1,fk_user2,amount) values(2,10001,10003,0);
--insert into balance(id,fk_user1,fk_user2,amount) values(3,10002,10003,0);
--insert into balance(id,fk_user1,fk_user2,amount) values(7,10003,10004,500);
